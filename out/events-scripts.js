export const EventsScripts = new Map();
EventsScripts.set("potions", potions);
async function potions(tge) {
    ...
    const potion_slowness = async () => {
        ...
        switch (chosen) {
            case 0:
                await drink("Вы попытались сделать шаг... На это у вас ушло 5 минут!");
                break;
            case 1:
                await drink("Вы стали двигаться намного медленней!");
                break;
            default:
                await drink("У вас закружилась голова... и всё");
                break;
        }
    };
    ...
    switch (chosen) {
        case 0:
            ...
            switch (chosen0) {
                case 0:
                    await drink("Сделав шаг, вы пронеслись через всю комнату с огромной скоростью!");
                    break;
                case 1:
                    await drink("Вы стали двигаться намного быстрее!");
                    break;
                case 2:
                    await potion_slowness();
                    break;
                default:
                    await drink("У вас закружилась голова... и всё");
                    break;
        ...
        case 1:
            ...
            switch (chosen1) {
                case 0:
                    await drink("Вы почувствовали легкость во всём теле и прыгнули... Теперь у вас болит голова от столкновения с потолком");
                    break;
                case 1:
                    await drink("Вы стали прыгать намного выше!");
                    break;
                case 2:
                    await potion_slowness();
                    break;
        ...
        case 2:
            ...
            switch (chosen2) {
                case 0:
                    await drink("Вы почувствовали небывалую силу и ударили стену... В ней теперь дыра");
                    break;
                case 1:
                    await drink("Вы почувствовали, что ваш рюкзак стал легче, странно...");
                    break;
                default:
                    await drink("У вас закружилась голова... и всё");
                    break;
        ...
        case 3:
            ...
            switch (chosen3) {
                case 0:
                    await drink("Все ваши раны залечились");
                    break;
                case 1:
                    await drink("Очнувшись, вы чувствуете себя так, как если бы вас ударили лопатой");
                    break;
                default:
                    await drink("У вас закружилась голова... и всё");
                    break;
        ...
        case 4:
            ...
            switch (chosen4) {
                case 0:
                    await drink("Вас стало сильно качать, у вас поднялась температура и вы уснули");
                    break;
                case 1:
                    await drink("Теперь у вас кружится голова и болит горло");
                    break;
                case 2:
                    await drink("Очнувшись, вы чувствуете себя так, как если бы вас ударили лопатой");
                    break;
        ...
        case 5:
            ...
            switch (chosen5) {
                case 0:
                    await drink("Вы чувствуете как с каждой секундой вам становится всё лучше и лучше");
                    break;
                case 1:
                    await drink("Вы заметили, что раны стали потихоньку затягиваться");
                    break;
                default:
                    await drink("У вас закружилась голова... и всё");
                    break;
        ...
        case 6:
            ...
            switch (chosen6) {
                case 0:
                    await drink("Теперь вы можете разглядеть даже самые тёмне углы комнаты &i^gray^'кто-то включил свет?'");
                    break;
                case 1:
                    await drink("Вы положили бутылёк обратно на стол. Стоп! А где ваши руки? А вы сами? Вы тут?");
                    break;
                default:
                    await drink("У вас закружилась голова... и всё");
                    break;
